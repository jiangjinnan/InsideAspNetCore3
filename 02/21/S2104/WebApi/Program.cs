        ...
        public static void Main()
        {
            ...
            Host.CreateDefaultBuilder()
                .ConfigureWebHostDefaults(builder => builder
                    ...
                    .ConfigureServices(svcs => svcs.AddCors(options => options.AddDefaultPolicy(
                        builder => builder.SetIsOriginAllowed(origin => allowedOrigins.Contains(new Uri(origin).Host)))))
                    .Configure(app => app
